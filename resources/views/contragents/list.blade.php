        ...
        <div class="card-body">
            <div>
                <form action="/addcontragent" method="Post" class="row g-3">
                    @csrf
                    <div class="col-10">
                       <input type="text" class="form-control" id="contr_name" name="contr_name" placeholder="Контрагент" aria-label="Контрагент">
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" id="contr_bulstat" name="contr_bulstat" placeholder="Булстат" aria-label="Булстат">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="contr_iban" name="contr_iban" placeholder="IBAN" aria-label="IBAN">
                    </div>
                    <div class="col-md-6">
